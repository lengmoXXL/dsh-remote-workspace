...
function binaryAssetName(binary, platform, arch) {
	...
	if (os === void 0 || cpu === void 0) throw new Error(`the machine reports platform "${platform.trim()}" and architecture "${arch.trim()}", which has no ${binary} release; it ships for Linux and Darwin on x86_64 and aarch64`);
