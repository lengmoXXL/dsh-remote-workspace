...
export const zh = {
  ...
  'worker.installing': '正在安装 PTC 运行宿主…',
  'worker.failed': 'PTC 运行宿主安装失败：{error}',
  'status.idle': '未连接',
  'status.failed': '连接失败',
...
export const en = {
  ...
  'worker.installing': 'Installing the PTC program host…',
  'worker.failed': 'The PTC program host could not be installed: {error}',
